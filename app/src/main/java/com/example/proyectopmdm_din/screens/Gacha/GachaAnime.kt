...
/**
 * @Composable función que representa la pantalla GachaAnime.
 *
 * Muestra una interfaz para el usuario con un encabezado, opciones de navegación y un botón de retroceso/cierre de sesión.
 *
